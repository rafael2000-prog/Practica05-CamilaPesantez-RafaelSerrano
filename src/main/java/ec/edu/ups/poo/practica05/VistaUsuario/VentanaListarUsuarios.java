...
public class VentanaListarUsuarios extends javax.swing.JInternalFrame {
     ...
     */
    public VentanaListarUsuarios(UsuarioControlador usuarioControlador) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblUsuarios.setBackground(new java.awt.Color(255, 255, 153));
    ...
    public void cambiarIdioma(Locale locale) {
        ...
        String cedula = mensajes.getString("lblcedula");
        String nombre = mensajes.getString("lblnombre");
        String correo = mensajes.getString("lblCorreo");
        DefaultTableModel tabla = (DefaultTableModel) tblUsuarios.getModel();
        tabla.setColumnIdentifiers(new String [] {cedula, nombre,correo });
        this.setTitle(mensajes.getString("ListarClientes"));
